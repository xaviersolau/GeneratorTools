...
[![codecov](https://codecov.io/github/xaviersolau/GeneratorTools/graph/badge.svg?token=2BIPC0IYGL)](https://codecov.io/github/xaviersolau/GeneratorTools)
...
```bash
Install-Package SoloX.GeneratorTools.Core.CSharp -version 1.0.0-alpha.46
```

**Install using the .Net CLI:**
```bash
dotnet add package SoloX.GeneratorTools.Core.CSharp --version 1.0.0-alpha.46
```

**Install editing your project file (csproj):**
```xml
<PackageReference Include="SoloX.GeneratorTools.Core.CSharp" Version="1.0.0-alpha.46" />
```
