...
namespace SoloX.GeneratorTools.Core.CSharp.Examples
{
    ...
    public class ModelGeneratorExample
    {
        ...
        public void Generate(string projectFile)
        {
            ...
            var generator = new AutomatedGenerator(new FileWriter(".generated.cs"), locator, resolver, typeof(ModelPattern), new GeneratorLogger<ModelGeneratorExample>(this.logger));
