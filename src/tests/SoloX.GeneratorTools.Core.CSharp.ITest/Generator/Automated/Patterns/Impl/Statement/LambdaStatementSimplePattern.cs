// ----------------------------------------------------------------------
// <copyright file="LambdaStatementSimplePattern.cs" company="Xavier Solau">
...
namespace SoloX.GeneratorTools.Core.CSharp.ITest.Generator.Automated.Patterns.Impl.Statement
{
    ...
    public class LambdaStatementSimplePattern : ISimplePattern
    {
        ...
        {
            return items.Count(i => i == PatternProperty);
        }
    }
}
