// ----------------------------------------------------------------------
// <copyright file="SimpleMethod5Pattern.cs" company="Xavier Solau">
...
namespace SoloX.GeneratorTools.Core.CSharp.ITest.Generator.Automated.Patterns.Impl
{
    ...
    public class SimpleMethod5Pattern : ISimpleMethodPattern
    {
        ...
        public object PatternMethod([Repeat(Pattern = "someArgument")] object someArgument)
        {
            ...
            var tmp2 = new string[] { "Any element", Repeat.Argument("someArgument", someArgument.ToString()) };
